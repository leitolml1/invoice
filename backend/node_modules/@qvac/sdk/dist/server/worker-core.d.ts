export declare function initializeWorkerCore(): {
    hasRPCConfig: boolean;
};
export declare function ensureRPCSetup(): void;
export declare function isCoreInitialized(): boolean;
export type BareDirectShutdownReason = 'signal' | 'rpc-close' | 'uncaught-exception' | 'unhandled-rejection' | 'ipc-disconnect';
/**
...
export declare function shutdownBareDirectWorker(reason: BareDirectShutdownReason): Promise<void>;
