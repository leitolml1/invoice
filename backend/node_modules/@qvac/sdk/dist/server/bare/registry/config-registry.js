...
import { CacheDirNotAbsoluteError, CacheDirNotWritableError, ConfigAlreadySetError } from '../../../utils/errors-server.js';
import { getServerLogger, setGlobalConsoleOutput, setGlobalLogLevel } from '../../../logging/index.js';
...
export function setSDKConfig(config) {
    ...
    if (config.cacheDirectory !== undefined && config.cacheDirectory !== null) {
        ...
        try {
            ...
            throw new CacheDirNotWritableError(config.cacheDirectory, error instanceof Error ? error.message : String(error), error);
        }
    ...
    if (config.registryDownloadMaxRetries !== undefined &&
...
export function getConfiguredCacheDir() {
