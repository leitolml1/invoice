...
import { cancelInferenceBaseSchema } from '../../../schemas/index.js';
import { ModelNotLoadedError } from '../../../utils/errors-server.js';
 ...
 */
export function cancel(params, opts) {
    ...
    if (cancelled === 0) {
        ...
        logger.debug(`[cancel] no in-flight request matched modelId=${modelId}${opts?.kind ? ` kind=${opts.kind}` : ''}`);
    }
    return cancelled;
}
