...
const activeRagRequestByWorkspace = new Map();
export function getWorkspaceKey(workspace) {
 ...
 */
export function getActiveRagRequest(workspace) {
 ...
 */
export function setActiveRagRequest(workspace, requestId) {
 ...
 */
export function clearActiveRagRequest(workspace, requestId) {
 ...
 */
export function cancelAllRagOperations() {
    if (activeRagRequestByWorkspace.size === 0)
        return;
