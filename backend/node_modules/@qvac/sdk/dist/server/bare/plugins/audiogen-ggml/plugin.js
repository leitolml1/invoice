...
import { ADDON_AUDIOGEN, ModelType, audioGenConfigSchema, audioGenStreamRequestSchema, audioGenStreamResponseSchema, defineHandler, definePlugin } from '../../../../schemas/index.js';
import { createStreamLogger, registerAddonLogger } from '../../../../logging/index.js';
import { resolveAudioGenConfig } from '../../../../server/bare/plugins/audiogen-ggml/config.js';
import { audioGenStream } from '../../../../server/bare/plugins/audiogen-ggml/ops/audio-gen-stream.js';
...
export const audioGenPlugin = definePlugin({
    ...
    createModel(params) {
        ...
        if (!textEncModel || !lmModel || !ditModel || !vaeModel) {
            throw new ModelLoadFailedError('AudioGen requires resolved text encoder, LM, DiT, and VAE model artifacts');
        }
