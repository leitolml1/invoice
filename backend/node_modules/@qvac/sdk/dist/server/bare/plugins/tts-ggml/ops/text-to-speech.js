...
function hasRunStream(model) {
    return (typeof model === 'object' &&
        model !== null &&
        'runStream' in model &&
        typeof model.runStream === 'function');
}
export async function* textToSpeech(params) {
    const request = ttsRequestSchema.parse(params);
    const { modelId, inputType, text, stream, sentenceStream, sentenceStreamLocale, sentenceStreamMaxChunkScalars } = request;
    ...
    if (sentenceStream) {
        ...
        const streamOpts = sentenceStreamLocale !== undefined ||
