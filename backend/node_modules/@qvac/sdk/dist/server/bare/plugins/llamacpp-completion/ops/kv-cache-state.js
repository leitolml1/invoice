 ...
 */
export function shouldCommitCachedTurn(context) {
    const { aborted, producedTokens, generatedTokens, predict } = context;
    const stoppedByBudget = predict !== undefined &&
        predict > 0 &&
 ...
 */
export function decideCachedHistorySlice(savedCount, cacheExists, history) {
