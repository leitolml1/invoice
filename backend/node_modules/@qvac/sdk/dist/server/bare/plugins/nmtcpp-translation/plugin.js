...
import { definePlugin, defineHandler, translateRequestSchema, translateResponseSchema, ModelType, nmtConfigBaseSchema, ADDON_NMT, BERGAMOT_CJK_LANG_PAIRS } from '../../../../schemas/index.js';
import { createStreamLogger, registerAddonLogger } from '../../../../logging/index.js';
import path from 'bare-path';
import { translate } from '../../../../server/bare/ops/translate.js';
import { attachModelExecutionMs } from '../../../../profiling/model-execution.js';
import { resolveBergamotVocab } from '../../../../server/bare/plugins/nmtcpp-translation/resolve-vocab.js';
/**
 ...
 */
function deriveColocatedBergamotVocabPaths(modelPath) {
...
function createNmtModel(modelId, modelPath, nmtConfig, srcVocabPath, dstVocabPath, pivotModelPath, pivotSrcVocabPath, pivotDstVocabPath) {
    ...
    const { mode, from, to, engine, beamsize, lengthpenalty, maxlength, repetitionpenalty, norepeatngramsize, temperature, topk, topp } = nmtConfig;
    const files = {
        model: modelPath,
...
export const nmtPlugin = definePlugin({
    ...
    async resolveConfig(cfg, ctx) {
        const { srcVocabSrc, dstVocabSrc, pivotModel, ...nmtConfig } = cfg;
    ...
    createModel(params) {
        const nmtConfig = (params.modelConfig ?? {});
        ...
        const { model } = createNmtModel(params.modelId, params.modelPath, nmtConfig, srcVocabPath, dstVocabPath, pivotModelPath, pivotSrcVocabPath, pivotDstVocabPath);
        return { model };
    },
    handlers: {
