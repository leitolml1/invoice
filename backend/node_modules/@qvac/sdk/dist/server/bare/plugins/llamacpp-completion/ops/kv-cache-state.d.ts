...
export declare function shouldCommitCachedTurn(context: CacheCommitContext): boolean;
/**
 ...
 */
export declare function decideCachedHistorySlice(savedCount: number, cacheExists: boolean, history: HistoryMessage[]): HistorySliceDecision;
export {};
//# sourceMappingURL=kv-cache-state.d.ts.map