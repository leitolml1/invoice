import { TOOLS_MODE } from '../../../../schemas/index.js';
/**
 ...
 */
export function transformLlmConfig(llmConfig) {
    const transformed = JSON.parse(JSON.stringify(llmConfig, (key, v) => key === 'modelType' || key === 'system_prompt'
        ? undefined
        : key === 'stop_sequences'
            ? Array.isArray(v)
                ? v.join(', ')
