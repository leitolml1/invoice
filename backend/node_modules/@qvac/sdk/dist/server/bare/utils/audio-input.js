...
import { needsDecoding, decodeAudioToStream } from '../../../server/utils/audio/decoder.js';
import { AudioFileNotFoundError, InvalidAudioChunkError } from '../../../utils/errors-server.js';
/**
 ...
 */
export async function createAudioStream(audioChunk, audioFormat) {
