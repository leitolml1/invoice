import type { ShardPatternInfo, ShardUrl } from '../../schemas/index.js';
/**
 * Detect if model filename follows shard pattern (00001-of-0000x)
 */
export declare function detectShardedModel(filename: string): ShardPatternInfo;
/**
 ...
 */
export declare function generateShardFilenames(shardName: string): string[];
/**
 ...
 */
export declare function parsePatternBasedShardUrl(shardUrl: string): {
    shardUrls: ShardUrl[];
    cacheKey: string;
};
/**
 ...
 */
export declare function extractTensorsFromShards(shardDir: string, shardFilename: string): Promise<string>;
/**
 ...
 */
export declare function checkAllShardsExist(shardDir: string, shardFilename: string): Promise<boolean>;
/**
 ...
 */
export declare function validateShardedModelCache(shardDir: string, shardFilename: string): Promise<boolean>;
