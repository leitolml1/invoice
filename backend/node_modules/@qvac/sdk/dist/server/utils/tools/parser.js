import { stripThinkingBlocks } from '../../../server/utils/tools/shared.js';
import { parseGemmaFormat, parseGenericFormat, parseLlamacppFormat } from '../../../server/utils/tools/parsers/json.js';
import { parseHermesFormat } from '../../../server/utils/tools/parsers/hermes.js';
import { parsePythonicFormat } from '../../../server/utils/tools/parsers/pythonic.js';
import { parseHarmonyFormat } from '../../../server/utils/tools/parsers/harmony.js';
import { parseQwen35Format } from '../../../server/utils/tools/parsers/qwen35.js';
import { parseGemma4NativeFormat } from '../../../server/utils/tools/parsers/gemma4native.js';
import { parseDsmlFormat } from '../../../server/utils/tools/parsers/dsml.js';
