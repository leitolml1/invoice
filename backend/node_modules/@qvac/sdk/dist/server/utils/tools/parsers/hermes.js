import { generateStableToolCallId, isValidToolCall, validateToolArguments } from '../../../../server/utils/tools/shared.js';
...
export function parseHermesFormat(text, tools) {
    const toolCalls = [];
    const errors = [];
...
function recoverIncompleteHermesFrame(text, tools) {
