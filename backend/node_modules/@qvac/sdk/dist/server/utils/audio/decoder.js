...
export async function decodeAudioToStream(inputPath, audioFormat = 's16le') {
    ...
    try {
        ...
        const timeoutId = setTimeout(() => {
            if (!hasEnded) {
                hasEnded = true;
                const timeoutError = new Error(`Audio decoding timed out after ${DECODER_TIMEOUT_MS}ms for file: ${inputPath}`);
