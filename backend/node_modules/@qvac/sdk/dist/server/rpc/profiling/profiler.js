...
import { responseSchema, DELEGATION_BREAKDOWN_KEY, OPERATION_EVENT_KEY, PROFILING_TRAILER_KEY } from '../../../schemas/index.js';
import { createProfilingContext, injectProfilingIntoString } from './context.js';
const noopProfiler = {
    markRequestParsed: () => { },
    ...
    return {
        ...
        serialize: (response, final = true) => {
            if (!response) {
                const opts = { ctx };
                if (cachedDelegation)
                    opts.delegation = cachedDelegation;
                if (cachedOperation)
