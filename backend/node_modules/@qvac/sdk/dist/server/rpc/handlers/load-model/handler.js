...
import { loadModel } from '../../../../server/bare/ops/load-model.js';
import { createResolveSession } from '../../../../server/rpc/handlers/load-model/resolve-session.js';
import { nowMs, generateProfileId } from '../../../../profiling/clock.js';
import { getModelEntry, updateModelConfig } from '../../../../server/bare/registry/model-registry.js';
import { generateShortHash, canonicalConfigString, transformConfigForReload } from '../../../../server/utils/index.js';
import { buildDownloadProfilingFields } from '../../../../server/rpc/handlers/load-model/types.js';
import { readBackendDiagnostics } from '../../../../server/rpc/profiling/backend-diagnostics.js';
import { ConfigReloadNotSupportedError, InferenceCancelledError, ModelTypeMismatchError, ModelIsDelegatedError, ModelNotFoundError, ModelLoadFailedError, PluginLoadConfigValidationFailedError, PluginNotFoundError } from '../../../../utils/errors-server.js';
    ...
    try {
        ...
        try {
            ...
            if ('modelPath' in pluginArtifacts) {
                throw new ModelLoadFailedError('Plugin returned reserved key "modelPath" in artifacts; primary model resolution is core-owned');
            }
