...
export function setupConnectionHandlers(swarm) {
    ...
    swarm.on('connection', (conn) => {
        ...
        if (!hasActiveProviders()) {
            logger.debug(`🚪 Dropping inbound connection from ${peerPubkey?.substring(0, 16)}... — provider is stopped`);
            conn.destroy();
            return;
        }
