 ...
 */
function resolveDelegationTarget(request) {
    if (request.operation !== 'broad')
        return null;
...
export async function handleCancelDelegated(request, options) {
