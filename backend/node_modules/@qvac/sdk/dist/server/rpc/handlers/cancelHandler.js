import { cancel as cancelByModelId } from '../../../server/bare/ops/cancel.js';
import { getRequestRegistry } from '../../../server/bare/runtime/index.js';
import { markClearCacheForRequest } from '../../../server/rpc/handlers/load-model/download-manager.js';
 ...
 * race window.
 */
export function cancelHandler(request) {
    try {
        ...
        // operation === "broad"
        const cancelled = cancelByModelId({ modelId: request.modelId }, request.kind ? { kind: request.kind } : undefined);
        return { type: 'cancel', success: true, cancelled };
    }
    catch (error) {
