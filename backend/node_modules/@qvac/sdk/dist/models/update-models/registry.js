...
import { groupShardedModels } from './shards.js';
import { groupCompanionSets } from './companions.js';
import { processRegistryModel } from './processing.js';
import { DEFAULT_REGISTRY_CORE_KEY } from '../../constants/index.js';
// Re-export for backward compat
export { processRegistryModel, extractModelName, toHexString } from './processing.js';
export async function collectModels(options = {}) {
    const { showDuplicates = false, noDedup = false } = options;
    const models = [];
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    const registryCoreKey = process.env['QVAC_REGISTRY_CORE_KEY'] ?? DEFAULT_REGISTRY_CORE_KEY;
...
export function deduplicateModels(models, showDuplicates) {
    ...
    const companionReferencedPaths = new Set();
