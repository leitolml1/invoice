import { generateExportName } from './naming.js';
export function generateModelsFileContent(models) {
...
function assignName(m, usedNames) {
...
function generateFileContentWithNames(modelsWithNames) {
...
import type { ENGINE_TO_ADDON } from "../../schemas/engine-addon-map.js";
