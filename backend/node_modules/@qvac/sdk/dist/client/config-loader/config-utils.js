import { qvacConfigSchema } from '../../schemas/index.js';
import { ConfigValidationFailedError } from '../../utils/errors-client.js';
...
export function parseJsonConfig(content, filePath) {
    try {
