import type { ModelRegistryEntry, ModelRegistryEntryAddon } from '../../schemas/index.js';
 ...
 */
declare function modelRegistryList(): Promise<ModelRegistryEntry[]>;
/**
 ...
 * @throws {ModelRegistryQueryFailedError} When the registry query fails.
 */
declare function modelRegistrySearch(params?: ModelRegistrySearchParams): Promise<ModelRegistryEntry[]>;
/**
 ...
 */
declare function modelRegistryGetModel(registryPath: string, registrySource: string): Promise<ModelRegistryEntry>;
