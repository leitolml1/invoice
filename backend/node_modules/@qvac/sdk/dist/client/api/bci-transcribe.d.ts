import { type BciTranscribeClientParams, type BciTranscribeStreamClientParams, type BciTranscribeStreamSession, type BciTranscribeStreamMetadataSession, type RPCOptions, type TranscribeSegment } from '../../schemas/index.js';
/**
 ...
 */
export declare function bciTranscribe(params: BciTranscribeClientParams & {
    metadata: true;
}, options?: RPCOptions): Promise<TranscribeSegment[]> & {
    requestId: string;
};
export declare function bciTranscribe(params: BciTranscribeClientParams, options?: RPCOptions): Promise<string> & {
    requestId: string;
};
/**
 ...
 *          `cancel({ requestId })`.
 */
export declare function bciTranscribeStream(params: BciTranscribeStreamClientParams & {
    metadata: true;
}, options?: RPCOptions): Promise<BciTranscribeStreamMetadataSession>;
export declare function bciTranscribeStream(params: BciTranscribeStreamClientParams, options?: RPCOptions): Promise<BciTranscribeStreamSession>;
