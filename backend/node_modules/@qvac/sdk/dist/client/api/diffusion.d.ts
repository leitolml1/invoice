import { type DiffusionClientParams, type DiffusionStats } from '../../schemas/index.js';
 ...
 * ```
 */
export declare function diffusion(params: DiffusionClientParams): DiffusionResult;
export {};
