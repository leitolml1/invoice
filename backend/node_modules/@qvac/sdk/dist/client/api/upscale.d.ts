import { type UpscaleClientParams, type UpscaleStats } from '../../schemas/sdcpp-config.js';
 ...
 * ```
 */
export declare function upscale(params: UpscaleClientParams): UpscaleResult;
export {};
