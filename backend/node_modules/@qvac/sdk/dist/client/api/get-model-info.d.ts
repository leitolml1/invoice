import { type GetModelInfoParams } from '../../schemas/index.js';
/**
 ...
 */
export declare function getModelInfo(params: GetModelInfoParams): Promise<{
    name: string;
    modelId: string;
    expectedSize: number;
    sha256Checksum: string;
    addon: "embeddings" | "diffusion" | "audiogen" | "tts" | "ocr" | "vla" | "llm" | "whisper" | "bci" | "nmt" | "parakeet" | "classification" | "vad" | "other";
    isCached: boolean;
    isLoaded: boolean;
    cacheFiles: {
        filename: string;
    ...
    blobBlockOffset?: number | undefined;
    blobBlockLength?: number | undefined;
    blobByteOffset?: number | undefined;
