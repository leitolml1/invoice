import { type ClassifyClientParams, type ClassificationResult } from '../../schemas/index.js';
/**
 ...
 * ```
 */
export declare function classify(params: ClassifyClientParams): Promise<ClassificationResult[]>;
