import type { LoggingStreamResponse, LoggingParams } from '../../schemas/logging-stream.js';
/**
 ...
 * ```
 */
export declare function loggingStream(params: LoggingParams): AsyncGenerator<LoggingStreamResponse>;
