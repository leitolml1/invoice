 ...
 */
export declare const ModelTypeAliases: {
    readonly llm: "llamacpp-completion";
    readonly whisper: "whispercpp-transcription";
    readonly bci: "bci-whispercpp-transcription";
    readonly embeddings: "llamacpp-embedding";
    readonly nmt: "nmtcpp-translation";
    readonly parakeet: "parakeet-transcription";
    readonly tts: "tts-ggml";
    readonly ocr: "ggml-ocr";
    readonly diffusion: "sdcpp-generation";
    readonly audiogen: "audiogen-ggml";
    readonly vla: "ggml-vla";
    readonly classification: "ggml-classification";
};
 ...
 * ```
 */
export declare const PUBLIC_MODEL_TYPES: {
    readonly llm: "llamacpp-completion";
    readonly whisper: "whispercpp-transcription";
    readonly bci: "bci-whispercpp-transcription";
    readonly embeddings: "llamacpp-embedding";
...
export declare const modelTypeInputSchema: z.ZodEnum<{
...
export declare const modelTypeSchema: z.ZodPipe<z.ZodEnum<{
    embeddings: "embeddings";
    diffusion: "diffusion";
    audiogen: "audiogen";
    tts: "tts";
 ...
 */
export declare const whisperModelTypeSchema: z.ZodEnum<{
    "whispercpp-transcription": "whispercpp-transcription";
    whisper: "whisper";
}>;
 ...
 */
export declare const bciModelTypeSchema: z.ZodEnum<{
    "bci-whispercpp-transcription": "bci-whispercpp-transcription";
    bci: "bci";
}>;
 ...
 */
export declare const parakeetModelTypeSchema: z.ZodEnum<{
    "parakeet-transcription": "parakeet-transcription";
    parakeet: "parakeet";
}>;
 ...
 */
export declare const embeddingsModelTypeSchema: z.ZodEnum<{
    embeddings: "embeddings";
    "llamacpp-embedding": "llamacpp-embedding";
}>;
 ...
 */
export declare const nmtModelTypeSchema: z.ZodEnum<{
    "nmtcpp-translation": "nmtcpp-translation";
    nmt: "nmt";
}>;
 ...
 * - Canonical: `"tts-ggml"`
 */
export declare const ttsModelTypeSchema: z.ZodEnum<{
    tts: "tts";
    "tts-ggml": "tts-ggml";
}>;
 ...
 * - Canonical: `"ggml-ocr"`
 */
export declare const ocrModelTypeSchema: z.ZodEnum<{
    ocr: "ocr";
    "ggml-ocr": "ggml-ocr";
}>;
 ...
 */
export declare const diffusionModelTypeSchema: z.ZodEnum<{
    diffusion: "diffusion";
    "sdcpp-generation": "sdcpp-generation";
}>;
 ...
 */
export declare const audioGenModelTypeSchema: z.ZodEnum<{
    audiogen: "audiogen";
    "audiogen-ggml": "audiogen-ggml";
}>;
 ...
 * - Canonical: `"ggml-vla"`
 */
export declare const vlaModelTypeSchema: z.ZodEnum<{
    vla: "vla";
    "ggml-vla": "ggml-vla";
}>;
 ...
 */
export declare const classificationModelTypeSchema: z.ZodEnum<{
    "ggml-classification": "ggml-classification";
    classification: "classification";
}>;
