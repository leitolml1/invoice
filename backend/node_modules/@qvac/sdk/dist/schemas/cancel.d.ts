 ...
 */
export declare const cancelInferenceBaseSchema: z.ZodObject<{
    modelId: z.ZodString;
}, z.core.$strip>;
/**
 ...
 */
declare const cancelKindSchema: z.ZodEnum<{
 ...
 */
declare const cancelByRequestIdParamsSchema: z.ZodObject<{
 ...
 */
declare const cancelBroadParamsSchema: z.ZodObject<{
...
declare const cancelParamsSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    operation: z.ZodLiteral<"request">;
    requestId: z.ZodString;
    clearCache: z.ZodOptional<z.ZodBoolean>;
...
export declare const cancelRequestSchema: z.ZodIntersection<z.ZodObject<{
 ...
 */
export declare const cancelByRequestIdSugarSchema: z.ZodObject<{
    requestId: z.ZodString;
    clearCache: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strict>;
/**
 ...
 * boundary.
 */
export declare const cancelBroadSugarSchema: z.ZodObject<{
    modelId: z.ZodString;
    kind: z.ZodOptional<z.ZodEnum<{
        completion: "completion";
        batchCompletion: "batchCompletion";
 ...
 * `cancel({ modelId, kind? })`.
 */
export declare const cancelLegacyInferenceSugarSchema: z.ZodObject<{
    operation: z.ZodLiteral<"inference">;
    modelId: z.ZodString;
}, z.core.$strip>;
export declare const cancelLegacyEmbeddingsSugarSchema: z.ZodObject<{
    operation: z.ZodLiteral<"embeddings">;
    modelId: z.ZodString;
}, z.core.$strip>;
...
export type CancelClientInput = CancelParams | CancelByRequestIdSugar | CancelBroadSugar | CancelLegacyInferenceSugar | CancelLegacyEmbeddingsSugar;
export {};
