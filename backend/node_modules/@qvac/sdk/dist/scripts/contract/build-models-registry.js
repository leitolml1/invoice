import * as registry from '../../models/registry/index.js';
function isModelConstant(value) {
    return (value !== null &&
        typeof value === 'object' &&
        !Array.isArray(value) &&
 ...
 */
export function buildModelsRegistry() {
    const namespace = registry;
    const entries = Object.entries(namespace).filter(function (entry) {
