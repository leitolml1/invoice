 ...
 *
 */
import { bundleSdk } from '../commands/index.js';
...
console.log(`▸ This example will generate a worker bundle in ${qvacOutputDir} and delete it on exit.`);
console.log('▸ If you have an existing qvac/ folder with bundled files, they will be overwritten and removed.\n');
...
const { completion, translate, embed, loadModel, unloadModel, LLAMA_3_2_1B_INST_Q4_0, BERGAMOT_EN_ES, GTE_LARGE_FP16 } = await import('@qvac/sdk');
