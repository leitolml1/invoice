import { close, completion, LLAMA_3_2_1B_INST_Q4_0, loadModel, profiler } from '@qvac/sdk';
...
try {
    ...
    const delegationMetrics = Object.keys(json.aggregates).filter((k) => k.includes('delegation') || k.includes('delegated'));
