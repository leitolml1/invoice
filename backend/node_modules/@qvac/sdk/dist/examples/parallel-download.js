...
try {
    ...
    for (let i = 0; i < assets.length; i++) {
        ...
        const timeToFirst = t.firstProgress != null ? `${((t.firstProgress - t.start) / 1000).toFixed(1)}s` : 'N/A';
