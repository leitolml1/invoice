import { WHISPER_TINY } from '../models/registry/index.js';
import { downloadAsset, getModelInfo, loadModel, unloadModel } from '../index.js';
const printModelStatus = (info, label) => {
    console.log(`\n▸ ${label}`);
