...
export async function checkPrebuilds(options) {
    ...
    for (const host of hosts) {
        ...
        if (!present) {
            issues.push({
                ...
                message: `${formatAddonId(addon)} is missing a prebuild for ${host} ` +
...
export async function listBarePrebuildFiles(hostDir) {
    let entries;
    try {
