...
import { DEFAULT_HOSTS, DEFAULT_SDK_NAME } from '../../commands/bundle/constants.js';
import { CONFIG_CANDIDATES, resolveConfigForProject } from '../../client/config-loader/resolve-config.node.js';
import { getClientLogger } from '../../logging/index.js';
import { BareImportsMapNotFoundError } from '../../utils/errors-client.js';
import { resolvePluginSpecifiers, parseBuiltinSpecifier } from '../../commands/bundle/plugins.js';
import { generateWorkerEntry } from '../../commands/bundle/entry-gen.js';
import { runBarePack } from '../../commands/bundle/bare-pack.js';
import { generateAddonsManifest } from '../../commands/bundle/manifest.js';
import { createSdkImportResolver } from '../../commands/bundle/resolve-sdk-import.js';
...
export async function bundleSdk(options = {}) {
    ...
    if (configPath) {
        ...
        logger.info('   To customize bundling, create one of:\n' +
