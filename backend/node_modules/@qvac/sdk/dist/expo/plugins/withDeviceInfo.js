...
import { getProjectRootFromBaseConfig } from '../../expo/plugins/get-project-root.js';
let didRun = false;
/**
 ...
 */
function withDeviceInfo(config) {
    if (didRun) {
        return config;
    }
    didRun = true;
    ...
    if (!hasExpoDevice) {
        ...
        if (fs.existsSync(deviceInfoPath)) {
            fs.writeFileSync(deviceInfoPath, [
                `"use strict";`,
            ...
            console.log('[withDeviceInfo] 🔧 QVAC: expo-device not in app dependencies, stubbed device info');
        }
    }
    else {
