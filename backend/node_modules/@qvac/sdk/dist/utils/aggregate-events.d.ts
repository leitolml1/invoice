import type { CompletionError, CompletionEvent, CompletionFinal, CompletionStats, StopReason, ToolCall } from '../schemas/index.js';
import { type ToolHandlerMap } from '../utils/tool-helpers.js';
...
export declare function aggregateEvents(events: CompletionEvent[]): AggregatedEvents;
export declare function buildFinalFromEvents(events: CompletionEvent[], handlers: ToolHandlerMap): {
